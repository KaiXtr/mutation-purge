...
DIALOGS = {
'SHOP': [['Os produtos estão nas pratileiras','é só você ir pegar e trazer aqui',0,'O quê? você quer que eu vá buscar pra você?!']],
'990435671': [[PLAYER[0]['NAME']+'! Precisamos de você aqui AGORA!','Parece que é um poltergeist, estamos na Av. Jobim, venha logo!',[7, 'Poltergeist na Av. Jobim']],['Caramba '+PLAYER[0]['NAME']+', será que você não entende a gravidade da situação??','Só você pode deter essa anomalia!']],\
